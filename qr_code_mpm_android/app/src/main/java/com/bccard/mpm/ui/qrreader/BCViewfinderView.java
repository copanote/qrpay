...
public class BCViewfinderView extends ViewfinderView {
    protected static final String TAG = BCViewfinderView.class.getSimpleName();
    ...
    public BCViewfinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
