...
public class MpmQrInfoReqDto {
    ...
    @Schema(description = "STATIC, DYNAMIC",
            example = "STATIC",
    ...
    @Schema(description = "mpmqr 금액, DYNAMIC일 때 필수, STATIC일 경우 무시한다.",
            minimum = "10",
            maximum = "99999999")
    private Long amount;

    @Schema(description = "할부개월수(00: 일시불), DYNAMIC일 때 필수, STATIC일 경우 무시한다.",
            minimum = "00",
            maximum = "24")
