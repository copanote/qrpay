...
public class EmvMpmTest {
    ...
    void test_createMpmQr() throws ParserConfigurationException, IOException, SAXException {
        ...
        EmvMpmNode testqrrefid = emvMpmService.publishStaticBcEmvMpmQr(emd, "", merchant, "MQ2025900013681", "410");
        System.out.println(testqrrefid.toString());
        System.out.println(testqrrefid.toQrCodeData());


        EmvMpmNode dynamicMpm = emvMpmService.publishDynamicBcEmvMpmQr(emd, "", merchant, "MQ2025900013681", "410", 1234, 0);
